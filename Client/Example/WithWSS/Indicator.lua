...
function WSS_Indicator:Constructor()
    ...
    local ContainerBorder = WGUI.CreateWithTags(Border, "#IndicatorBorder", self)

    -- Creates a flex box inside the border. This flex box will be used by inherited classes to add their content.
    local ContentFlexBox = WGUI.CreateWithTags(FlexBox, "#IndicatorContent", ContainerBorder, Orientation.Horizontal)
